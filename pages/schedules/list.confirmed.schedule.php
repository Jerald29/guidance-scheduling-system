...
<head>
    ...
    <title>Confirmed Schedule List | GCS Bacoor</title>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Confirmed Schedule List</h1>
                        </div>
                        <div class="col-sm-6">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <table id="example2" class="table table-bordered table-hover">
                            ...
                            <tbody>
                                <?php
                                // Fetch schedules from the database with student names, emails, and images
                                $sql = "SELECT s.schedule_id, st.student_fname, st.student_lname, st.student_mname, st.img, st.email, s.appointment_date, s.appointment_time, s.status
                                        FROM tbl_schedules as s
                                        LEFT JOIN tbl_students as st ON s.student_id = st.student_id WHERE s.status = 'confirmed'
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $row['email']; ?></td> <!-- Display student's email -->
                                    <td>
