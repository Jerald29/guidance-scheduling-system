...
<head>
    ...
    <title>Cancelled Schedule List | GCS Bacoor</title>
        ...
        <div class="content-wrapper">
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Cancelled Schedule List</h1>
                        </div>
                        <div class="col-sm-6">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <table id="example2" class="table table-bordered table-hover">
                            ...
                            <tbody>
                                <?php
                                // Fetch cancelled schedules from the database
                                ...
                                <?php
                                    ...
                                    echo "<tr><td colspan='7' class='text-center'>No cancelled schedules found.</td></tr>";
                                }
                                ?>
                            </tbody>
                        </table>
