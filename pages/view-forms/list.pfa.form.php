...
<head>
    ...
    <title>PFA Forms | GCS Bacoor</title>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Student's Psychological First Aid Forms</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                        ...
                        <table id="example2" class="table table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                if (isset($_GET['search'])) {
                                    ...
                                    // Modified query with table aliases for tbl_students (stud), tbl_stud_info (info), and tbl_pfa_forms (pfa)
                                    $student_info = mysqli_query($conn, "SELECT 
                                                                        ...
                                                                        LEFT JOIN tbl_pfa_forms AS pfa ON stud.student_id = pfa.student_id
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <?php if (!$row['info_id'] || !$row['pfa_id']): ?>
                                            <button class="btn btn-warning btn-sm rounded" data-toggle="modal" data-target="#profileIncompleteModal<?= htmlspecialchars($row['student_id']) ?>">View PFA Form</button>
                                                ...
                                                <div class="modal-dialog modal-md">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h4 class="modal-title text-danger"><b>PFA Form Incomplete</b></h4>
                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                <span aria-hidden="true">&times;</span>
                                                            </button>
                                                        </div>
                                                        <div class="modal-body">
                                                            <p>This student has not completed their PFA form yet.<br>
                                                            Please remind them to complete it for better assistance.</p>
                                                        </div>
                                        ...
                                        <?php else: ?>
                                            <a href="../fillup/view.pfa.php?student_id=<?= htmlspecialchars($row['student_id']) ?>" class="btn btn-info btn-sm m-1">View PFA Form</a>
                                        <?php endif; ?>
                                    </td>
                                </tr>
                                <?php
